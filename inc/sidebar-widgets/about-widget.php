...
class ararat_about_widget extends WP_Widget {
...
esc_html__( '[ Ararat ] About Widget', 'ararat-companion' ), 

// Widget description
array( 'description' => esc_html__( 'Add footer about content', 'ararat-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'About', 'ararat-companion' );
}
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'textarea' ) ); ?>"><?php esc_html_e( 'About Content:' ,'ararat-companion'); ?></label> 
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php _e( 'Image', 'ararat-companion' ); ?>:</label>
	<div class="ararat-media-container">
		<div class="ararat-media-inner">
			...
			<span class="ararat-no-image" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'ararat-companion' ); ?></span>
		</div>
	
	<input type="text" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'image' ) ); ?>" value="<?php echo esc_attr( $image ); ?>" class="ararat-media-url" />

	<input type="button" value="<?php echo _e( 'Remove', 'ararat-companion' ); ?>" class="button ararat-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

	<?php $button_text = ( $image != '' ) ? __( 'Change Image', 'ararat-companion' ) : __( 'Select Image', 'ararat-companion' ); ?>
	<input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button ararat-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-button" />
	<br class="clear">
	</div>
</p>
<style>
...
function ararat_about_load_widget() {
	register_widget( 'ararat_about_widget' );
}
add_action( 'widgets_init', 'ararat_about_load_widget' );