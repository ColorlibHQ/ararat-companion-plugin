...
class Ararat_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Ararat ] Social Links', 'ararat-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'ararat-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'ararat-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'ararat-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'ararat-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'ararat-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'ararat-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'ararat-companion'); ?></label>
...
} // Class ararat_social_links ends here


// Register and load the widget
function ararat_social_links_widget_load() {
	register_widget( 'Ararat_social_links' );
}
add_action( 'widgets_init', 'ararat_social_links_widget_load' );