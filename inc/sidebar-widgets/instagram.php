...
----------------------------------------*/
class ararat_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('ararat_instagram_photo',esc_html__('[ Ararat ] Intagram Photo','ararat-companion'),array(
			'description' => esc_html__('Ararat Instagram Photo Widget','ararat-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'ararat-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'ararat-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'ararat-companion'); ?></label>
...
if(!function_exists('ararat_instagram_widgets')):
	function ararat_instagram_widgets(){
		register_widget('ararat_instagram_photo');
	}
	add_action('widgets_init','ararat_instagram_widgets');
endif;
